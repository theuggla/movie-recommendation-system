    ...
    return this.state.user ? (
      <div className='user__wrapper'>
        ...
        <div className='sim euclid__sim'>
          <Button label="Similar users - euclidian measure" onClick={() => {
        ...
        <div className='sim pearson__sim'>
          <Button label="Similar users - pearson measure" onClick={() => {
        ...
        <div className='rec euclid__rec'>
          <Button label="Recommended movies - euclidean measure" onClick={() => {
        ...
        <div className='rec pearson__recs'>
          <Button label="Recommended movies - pearson" onClick={() => {
